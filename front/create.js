...
stage(); dispOb(); container(); shape(); text()
function stage(){
...
function dispOb(){
    ...
    ob.CURSOR = ob.cu = ob.bM = function (cu) {
    ...
    ob.ca = function () {
        var ob = this, st = ob.st(), g = G(arguments), o, op, i
    ...
    ob.sp = ob.spin = function () {
        this.twL([{r: 360}, 4000]);
        return this
    }
    ob.d = ob.dot = function () {
        this.st().dot(this.X(), this.Y());
        return this
    }
...
function container(){ct = cjs.Container.prototype
    ct.ct = function (x, y) {
