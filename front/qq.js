...
$.sp=  function (fn) {     return $.kD('space', fn) }
...
//$.scroll =function(a){return $(window).scroll(a||function(){$('body').C('*')})}
    ...
    bd=function(){var bd= $('body'); return bd}
    ...
    function dims() {
        ...
        $.cW = function () {
            return $.bd().clientWidth
        }
        $.cH = function () {
            return $.bd().clientHeight
        }
    }
    function oh() {
        $.oh = function (a, b, c) {
